...
from progs_python.initialisation.initialisation import charge_fichier_cycla_défaut as charge_cycla_defaut, charge_ville, charge_villes, crée_zone
...
Les codes postaux ne servent que si le nom est ambigü.
""")
